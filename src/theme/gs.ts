...
export default StyleSheet.create({
  ...
  ///Font Family
  ffPoppinsRegular: {fontFamily: 'Poppins-Regular'},
  ffPoppinsMedium: {fontFamily: 'Poppins-Medium'},
  ffPoppinsSemiBold: {fontFamily: 'Poppins-SemiBold'},
  ffPoppinsBold: {fontFamily: 'Poppins-Bold'},
